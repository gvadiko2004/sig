...
function triggerPoint(section) {
  ...
  if (window.innerWidth <= 440) return rect.top <= window.innerHeight * 0.95;
...
/***********************************
 SERVICE (mobile — по элементам, desktop — при видимости секции)
***********************************/
function animateServiceSection() {
  ...
  blocks.forEach(
    (b) => ((b.style.opacity = "0"), (b.style.transform = "translateY(20px)"))
  );
...
/***********************************
 ACHIEVEMENTS (mobile — по элементам, desktop — при видимости секции)
***********************************/
function animateAchievementsSection() {
  ...
  function onScroll() {
    ...
    section.style.transition = text.style.transition =
      "opacity .6s ease, transform .6s ease";
    section.style.opacity = "1";
    section.style.transform = "translateY(0)";
...
/***********************************
 ADVANTAGES  (mobile per block, desktop full section)
***********************************/
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function onScroll() {
    if (!triggerPoint(formSection)) return;
